...
(jQuery.easing.jswing = jQuery.easing.swing),
  jQuery.extend(jQuery.easing, {
    ...
    easeInOutElastic: function (t, e, i, n, o) {
      ...
      return e < 1
        ? s * Math.pow(2, 10 * (e -= 1)) * Math.sin(((e * o - a) * (2 * Math.PI)) / r) * -0.5 + i
        : s * Math.pow(2, -10 * (e -= 1)) * Math.sin(((e * o - a) * (2 * Math.PI)) / r) * 0.5 + n + i;
    },
    ...
    easeInOutBounce: function (t, e, i, n, o) {
      return e < o / 2
        ...
        : 0.5 * jQuery.easing.easeOutBounce(t, 2 * e - o, 0, n, o) + 0.5 * n + i;
    },
  }),
  jQuery.Velocity
    ...
    : ((function (t) {
        function e(t) {
          ...
          return (
            'function' !== n &&
            !i.isWindow(t) &&
            (!(1 !== t.nodeType || !e) || 'array' === n || 0 === e || ('number' == typeof e && e > 0 && e - 1 in t))
          );
        }
        if (!t.jQuery) {
          var i = function (t, e) {
                    ...
                    (t = s[o]),
                      s !== (n = a[o]) &&
                        (u && n && (i.isPlainObject(n) || (e = i.isArray(n)))
                          ? (e ? ((e = !1), (r = t && i.isArray(t) ? t : [])) : (r = t && i.isPlainObject(t) ? t : {}),
                            (s[o] = i.extend(u, r, n)))
                          : void 0 !== n && (s[o] = n));
              return s;
            }),
      ...
      (function (t) {
        ...
        return (function (t, e, i, n) {
                ...
                if (g.State.calls[o]) {
                  ...
                  for (var v = Math.min((e - h) / d.duration, 1), b = 0, x = s.length; x > b; b++) {
                    ...
                    if (a(C)) {
                      ...
                      for (var M in (d.visibility !== n && 'hidden' !== d.visibility && y.setPropertyValue(C, 'visibility', d.visibility),
                      k))
                        if ('element' !== M) {
                          var T,
                            I = k[M],
                          ...
                          if (((I.currentValue = T), 'tween' === M)) m = T;
                            ...
                            var _ = y.setPropertyValue(
                              C,
                              M,
                              I.currentValue + (0 === parseFloat(T) ? '' : I.unitType),
                              I.rootPropertyValue,
                              I.scrollData
                            );
                            y.Hooks.registered[M] &&
                              (a(C).rootPropertyValueCache[A] = y.Normalizations.registered[A]
                                ? y.Normalizations.registered[A]('extract', null, _[1])
                                : _[1]),
                              'transform' === _[0] && (S = !0);
                          }
                        }
                  ...
                  d.display !== n && 'none' !== d.display && (g.State.calls[o][2].display = !1),
                    d.visibility !== n && 'hidden' !== d.visibility && (g.State.calls[o][2].visibility = !1),
                    d.progress && d.progress.call(r[1], r[1], v, Math.max(0, h + d.duration - e), h, m),
                    1 === v && c(o);
                }
            }
          ...
          function c(t, e) {
            ...
            for (
              ...
              if (
                (e ||
                  r.loop ||
                  ('none' === r.display && y.setPropertyValue(h, 'display', r.display),
                  'hidden' === r.visibility && y.setPropertyValue(h, 'visibility', r.visibility)),
          ...
          var u,
            ...
            f = !1;
          if ((t.fn && t.fn.jquery ? ((u = t), (f = !0)) : (u = e.Velocity.Utilities), 8 >= d && !f))
          ...
          if (!(7 >= d)) {
            ...
            e.pageYOffset !== n
              ? ((g.State.scrollAnchor = e), (g.State.scrollPropertyLeft = 'pageXOffset'), (g.State.scrollPropertyTop = 'pageYOffset'))
              ...
              return function t(e, n, o) {
                ...
                for (
                  e = parseFloat(e) || 500,
                    ...
                    l.tension = e,
                    l.friction = n,
                    (a = null !== o) ? (r = ((u = t(e, n)) / o) * 0.016) : (r = 0.016);
            ...
            var y = (g.CSS = {
              ...
              Hooks: {
                ...
                cleanRootPropertyValue: function (t, e) {
                  return (
                    y.RegEx.valueUnwrap.test(e) && (e = e.match(y.RegEx.valueUnwrap)[1]),
                      ...
                      case 'extract':
                        ...
                        return (
                          y.RegEx.wrappedValueAlreadyExtracted.test(i)
                            ? (n = i)
                            : (n = (n = i.toString().match(y.RegEx.valueUnwrap)) ? n[1].replace(/,(\s+)?/g, ' ') : i),
                          n
                        );
                      case 'inject':
                        return 'rect(' + i + ')';
                      ...
                      y.Normalizations.registered[e] = function (t, i, o) {
                        switch (t) {
                          ...
                          case 'extract':
                            ...
                            if (y.RegEx.wrappedValueAlreadyExtracted.test(o)) a = o;
                              ...
                              /^[A-z]+$/i.test(o)
                                ...
                                ? (r = 'rgb(' + y.Values.hexToRgb(o).join(' ') + ')')
                          ...
                          case 'inject':
                            return (
                              8 >= d
                                ? 4 === o.split(' ').length && (o = o.split(/\s+/).slice(0, 3).join(' '))
              ...
              getPropertyValue: function (t, i, o, r) {
                ...
                if (y.Hooks.registered[i]) {
                  var c = i,
                    h = y.Hooks.getRoot(c);
                  o === n && (o = y.getPropertyValue(t, y.Names.prefixCheck(h)[0])),
                    y.Normalizations.registered[h] && (o = y.Normalizations.registered[h]('extract', t, o)),
                    (l = y.Hooks.extractValue(c, o));
                } else if (y.Normalizations.registered[i]) {
                  var p, f;
                  'transform' !== (p = y.Normalizations.registered[i]('name', t)) &&
                    ((f = s(t, y.Names.prefixCheck(p)[0])),
                    y.Values.isCSSNullValue(f) && y.Hooks.templates[i] && (f = y.Hooks.templates[i][1])),
              ...
              setPropertyValue: function (t, i, n, o, r) {
                ...
                if ('scroll' === i)
                  ...
                  y.Normalizations.registered[i]('inject', t, n), (s = 'transform'), (n = a(t).transformCache[i]);
                else {
                  if (y.Hooks.registered[i]) {
                    var l = i,
                      c = y.Hooks.getRoot(i);
                  ...
                  if (
                    (y.Normalizations.registered[i] &&
                      ((n = y.Normalizations.registered[i]('inject', t, n)), (i = y.Normalizations.registered[i]('name', t))),
                ...
                if ((d || (g.State.isAndroid && !g.State.isChrome)) && a(t).isSVG) {
                  ...
                  u.each(a(t).transformCache, function (e) {
                    return (
                      ...
                      'transformPerspective' === e ? ((r = o), !0) : (9 === d && 'rotateZ' === e && (e = 'rotate'), void (i += e + o + ' '))
                    );
                  }),
                    r && (i = 'perspective' + r + ' ' + i);
                }
            ...
            var x = function () {
              ...
              function r() {
                function t(t) {
                      ...
                      p.isArray(t)
                        ? ((i = t[0]),
                          (!p.isArray(t[1]) && /^[\d-]/.test(t[1])) || p.isFunction(t[1]) || y.RegEx.isHex.test(t[1])
                            ? (a = t[1])
                            : ((p.isString(t[1]) && !y.RegEx.isHex.test(t[1])) || p.isArray(t[1])) &&
                              ((o = e ? t[1] : s(t[1], c.duration)), t[2] !== n && (a = t[2])))
                        : (i = t),
                      e || (o = o || c.easing),
                  ...
                  function m() {
                    ...
                    if (o && n)
                      ...
                      g.init(c),
                        ...
                        (l.percentToPxWidth = L.lastPercentToPxWidth = (parseFloat(y.getPropertyValue(c, 'width', null, !0)) || 1) / s),
                        (l.percentToPxHeight = L.lastPercentToPxHeight = (parseFloat(y.getPropertyValue(c, 'height', null, !0)) || 1) / s),
                        (l.emToPx = L.lastEmToPx = (parseFloat(y.getPropertyValue(c, 'paddingLeft')) || 1) / s),
                        t.myParent.removeChild(c);
                    }
                    return (
                      null === L.remToPx && (L.remToPx = parseFloat(y.getPropertyValue(i.body, 'fontSize')) || 16),
                    ...
                    c.container
                      ? p.isWrapped(c.container) || p.isNode(c.container)
                        ? ((c.container = c.container[0] || c.container),
                          (M = (x = c.container['scroll' + O]) + u(r).position()[O.toLowerCase()] + P))
                        : (c.container = null)
                      : ((x = g.State.scrollAnchor[g.State['scrollProperty' + O]]),
                        (k = g.State.scrollAnchor[g.State['scrollProperty' + ('Left' === O ? 'Top' : 'Left')]]),
                      ...
                      (d = {
                        scroll: {
                          ...
                          unitType: '',
                          easing: c.easing,
                          scrollData: { container: c.container, direction: O, alternateValue: k },
                        },
                        element: r,
                      }),
                    ...
                    for (var D in A)
                      if ('element' !== D) {
                        ...
                        (A[D].startValue = A[D].currentValue = A[D].endValue),
                          ...
                          g.debug && console.log('reverse tweensContainer (' + D + '): ' + JSON.stringify(A[D]), r);
                      }
                    d = A;
                  } else if ('start' === T) {
                    for (var E in (a(r).tweensContainer && !0 === a(r).isAnimating && (A = a(r).tweensContainer),
                    u.each(b, function (t, e) {
                      if (RegExp('^' + y.Lists.colors.join('$|^') + '$').test(t)) {
                        ...
                        if (y.RegEx.isHex.test(o)) {
                          for (
                            var s = ['Red', 'Green', 'Blue'], l = y.Values.hexToRgb(o), c = r ? y.Values.hexToRgb(r) : n, u = 0;
                            u < s.length;
                            u++
                          ) {
                            var d = [l[u]];
                      ...
                      if (a(r).isSVG || 'tween' === N || !1 !== y.Names.prefixCheck(N)[1] || y.Normalizations.registered[N] !== n) {
                        ((c.display !== n && null !== c.display && 'none' !== c.display) ||
                          ...
                          c._cacheValues && A && A[E]
                            ? (V === n && (V = A[E].endValue + A[E].unitType), (z = a(r).rootPropertyValueCache[N]))
                            : y.Hooks.registered[E]
                            ? V === n
                              ? ((z = y.getPropertyValue(r, N)), (V = y.getPropertyValue(r, E, z)))
                        ...
                        if (
                          ...
                          '%' === B &&
                            (/^(fontSize|lineHeight)$/.test(E)
                              ...
                              : /^scale/.test(E)
                              ? ((R /= 100), (B = ''))
                              : /(Red|Green|Blue)$/i.test(E) && ((R = (R / 100) * 255), (B = ''))),
                          /[\/*]/.test(Y))
                        )
                          B = j;
                        else if (j !== B && 0 !== V)
                        ...
                        (d[E] = { rootPropertyValue: z, startValue: V, currentValue: V, endValue: R, unitType: B, easing: W }),
                  ...
                  d.element &&
                    ...
                    (a(r).isAnimating = !0),
                    S === C - 1
                      ? (g.State.calls.push([$, v, c, null, I.resolver]), !1 === g.State.isTicking && ((g.State.isTicking = !0), l()))
                      : S++);
                }
                var o,
                  r = this,
                ...
                switch (
                  ...
                  parseFloat(c.delay) &&
                    ...
                    u.queue(r, c.queue, function (t) {
                      (g.velocityQueueEntryFlag = !0), (a(r).delayTimer = { setTimeout: setTimeout(t, parseFloat(c.delay)), next: t });
                    }),
                ...
                !1 !== g.mock &&
                  (!0 === g.mock
                    ...
                    : ((c.duration *= parseFloat(g.mock) || 1), (c.delay *= parseFloat(g.mock) || 1))),
              ...
              if (
                (p.isWrapped(this)
                  ...
                  : ((d = !0), (f = 1), (v = k ? arguments[0].elements || arguments[0].e : arguments[0])),
                (v = o(v)))
              ) {
                k
                ...
                switch (
                  ...
                  case 'stop':
                    u.each(v, function (t, e) {
                      a(e) &&
                        a(e).delayTimer &&
                        (clearTimeout(a(e).delayTimer.setTimeout), a(e).delayTimer.next && a(e).delayTimer.next(), delete a(e).delayTimer);
                    });
                    var O = [];
                    return (
                    ...
                    if (!u.isPlainObject(b) || p.isEmptyObject(b)) {
                      if (p.isString(b) && g.Redirects[b]) {
                        var P = (E = u.extend({}, w)).duration,
                          A = E.delay || 0;
                        return (
                          !0 === E.backwards && (v = u.extend(!0, [], v).reverse()),
                          u.each(v, function (t, e) {
                            parseFloat(E.stagger)
                              ? (E.delay = A + parseFloat(E.stagger) * t)
                              : p.isFunction(E.stagger) && (E.delay = A + E.stagger.call(e, t, C)),
                              E.drag &&
                                ((E.duration = parseFloat(P) || (/^(callout|transition)/.test(b) ? 1e3 : m)),
                                (E.duration = Math.max(E.duration * (E.backwards ? 1 - t / C : (t + 1) / C), 0.75 * E.duration, 200))),
                              g.Redirects[b].call(e, e, E || {}, t, C, v, I.promise ? I : n);
                          }),
                          t()
                        );
                      }
                      var D =
                        'Velocity: First argument (' + b + ') was not a property map, a known action, or a registered redirect. Aborting.';
            ...
            return (
              ...
              (t.Velocity = g),
              t !== e && ((t.fn.velocity = x), (t.fn.velocity.defaults = g.defaults)),
              u.each(['Down', 'Up'], function (t, e) {
                g.Redirects['slide' + e] = function (t, i, o, a, r, s) {
                  var l = u.extend({}, i),
                    ...
                    p = {};
                  l.display === n &&
                    (l.display = 'Down' === e ? ('inline' === g.CSS.Values.getDisplayType(t) ? 'inline-block' : 'block') : 'none'),
                    (l.begin = function () {
  ...
  (function (t) {
    if ('object' == typeof exports && 'undefined' != typeof module) module.exports = t();
      ...
      ('undefined' != typeof window ? window : 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : this).Chart =
        t();
    }
  })(function () {
    return (function () {
            ...
            function u(t) {
              ...
              return (
                ...
                [
                  ...
                  500 * (i - n),
                  200 * (n - (o = o > 0.008856 ? Math.pow(o, 1 / 3) : 7.787 * o + 16 / 116)),
                ]
              );
            }
            function d(t) {
            ...
            function y(t) {
              ...
              return (
                a <= 8
                  ...
                  : ((i = 100 * Math.pow((a + 16) / 116, 3)), (o = Math.pow(i / 100, 1 / 3))),
                [
        ...
        15: [
          function (t, e, i) {
            ...
            n._set('bar', {
              hover: { mode: 'label' },
              scales: {
                xAxes: [{ type: 'category', categoryPercentage: 0.8, barPercentage: 0.9, offset: !0, gridLines: { offsetGridLines: !0 } }],
                yAxes: [{ type: 'linear' }],
              },
            }),
                ...
                (t.controllers.bar = t.DatasetController.extend({
                    ...
                    (t._xScale = n.getScaleForId(r.xAxisID)),
                      ...
                      (t._model = {
                        ...
                        backgroundColor: l.backgroundColor
                          ? l.backgroundColor
                          : a.valueAtIndexOrDefault(s.backgroundColor, e, c.backgroundColor),
                    ...
                    for (e = 0; e < a; ++e)
                      (i = n.getDatasetMeta(e)).bar &&
                        ...
                        (!1 === o ||
                          ...
                          (void 0 === o && (void 0 === i.stack || -1 === r.indexOf(i.stack)))) &&
                        r.push(i.stack);
                    return r;
                  },
                  ...
                  calculateBarValuePixels: function (t, e) {
                    ...
                    return (
                      ...
                      { size: (s = ((r = u.getPixelForValue(m + h)) - a) / 2), base: a, head: r, center: r + s / 2 }
                    );
                  },
                        ...
                        'flex' === n.barThickness
                          ...
                          : (function (t, e, i) {
                              var n,
                                ...
                                l = e.pixels[t];
                              return (
                                a.isNullOrUndef(r) ? ((n = e.min * i.categoryPercentage), (o = i.barPercentage)) : ((n = r * s), (o = 1)),
              ...
              (e.exports = function (t) {
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                  ...
                  update: function (t) {
                    ...
                    if (p < 2 * Math.PI) {
                      var f = o.rotation % (2 * Math.PI),
                        ...
                        y = (f <= 0.5 * Math.PI && 0.5 * Math.PI <= m) || (f <= 2.5 * Math.PI && 2.5 * Math.PI <= m),
                  ...
                  updateElement: function (t, e, i) {
                    ...
                    (b.backgroundColor = y.backgroundColor ? y.backgroundColor : x(p.backgroundColor, e, w.backgroundColor)),
                      (b.borderColor = y.borderColor ? y.borderColor : x(p.borderColor, e, w.borderColor)),
                      (b.borderWidth = y.borderWidth ? y.borderWidth : x(p.borderWidth, e, w.borderWidth)),
                      (i && l.animateRotate) ||
              ...
              (e.exports = function (t) {
                ...
                t.controllers.line = t.DatasetController.extend({
                      ...
                      f &&
                        ...
                        (l._model = {
                          ...
                          cubicInterpolationMode: o.cubicInterpolationMode
                            ...
                            : a.valueOrDefault(p.cubicInterpolationMode, d.cubicInterpolationMode),
                        }),
                        l.pivot()),
                        i = 0,
                        n = c.length;
                  ...
                  getPointBackgroundColor: function (t, e) {
                    ...
                    return (
                      o.backgroundColor
                        ...
                        ? (i = a.valueAtIndexOrDefault(n.pointBackgroundColor, e, i))
                  ...
                  getPointBorderColor: function (t, e) {
                    ...
                    return (
                      o.borderColor
                        ? (i = o.borderColor)
                        : n.pointBorderColor
                        ? (i = a.valueAtIndexOrDefault(n.pointBorderColor, e, i))
                  ...
                  getPointRotation: function (t, e) {
                    ...
                    return (
                      isNaN(o.rotation)
                        ? (isNaN(n.pointRotation) && !a.isArray(n.pointRotation)) || (i = a.valueAtIndexOrDefault(n.pointRotation, e, i))
                        : (i = o.rotation),
                      i
                    );
                  },
                  ...
                  draw: function () {
                    ...
                    for (
                      ...
                      a.canvas.clipArea(i.ctx, { left: r.left, right: r.right, top: r.top - t, bottom: r.bottom + t }),
                      n.dataset.draw(),
                  ...
                  setHoverStyle: function (t) {
                    ...
                    (t.$previousStyle = {
                      ...
                      (o.backgroundColor =
                        ...
                        a.valueAtIndexOrDefault(e.pointHoverBackgroundColor, i, a.getHoverColor(o.backgroundColor))),
                      (o.borderColor =
                        n.hoverBorderColor || a.valueAtIndexOrDefault(e.pointHoverBorderColor, i, a.getHoverColor(o.borderColor))),
                      (o.borderWidth = n.hoverBorderWidth || a.valueAtIndexOrDefault(e.pointHoverBorderWidth, i, o.borderWidth)),
                      (o.radius =
                        n.hoverRadius || a.valueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius));
                  },
                });
              });
          },
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                  ...
                  update: function (t) {
                    var e,
                      ...
                      c = (o._starts = []),
                      u = (o._angles = []);
                    for (o._updateRadius(), s.count = o.countVisibleElements(), e = 0, i = r.data.length; e < i; e++)
                      (c[e] = l), (n = o._computeAngle(e)), (u[e] = n), (l += n);
                  ...
                  updateElement: function (t, e, i) {
                    ...
                    var b = this.chart.options.elements.arc,
                      ...
                      x = a.valueAtIndexOrDefault,
                      w = t._model;
                    (w.backgroundColor = y.backgroundColor ? y.backgroundColor : x(r.backgroundColor, e, b.backgroundColor)),
                      (w.borderColor = y.borderColor ? y.borderColor : x(r.borderColor, e, b.borderColor)),
                      (w.borderWidth = y.borderWidth ? y.borderWidth : x(r.borderWidth, e, b.borderWidth)),
                      t.pivot();
                  },
                    ...
                    void 0 !== r.radius && void 0 === r.pointRadius && (r.pointRadius = r.radius),
                      ...
                      a.extend(t, {
                        ...
                        _model: {
                          ...
                          backgroundColor: o.backgroundColor
                            ? o.backgroundColor
                            : a.valueAtIndexOrDefault(r.pointBackgroundColor, e, l.backgroundColor),
                  ...
                  setHoverStyle: function (t) {
                    ...
                    (t.$previousStyle = {
                      ...
                      (o.radius = i.hoverRadius
                        ? i.hoverRadius
                        : a.valueAtIndexOrDefault(e.pointHoverRadius, n, this.chart.options.elements.point.hoverRadius)),
                      (o.backgroundColor = i.hoverBackgroundColor
                        ? i.hoverBackgroundColor
                        : a.valueAtIndexOrDefault(e.pointHoverBackgroundColor, n, a.getHoverColor(o.backgroundColor))),
                      (o.borderColor = i.hoverBorderColor
                        ? i.hoverBorderColor
                        : a.valueAtIndexOrDefault(e.pointHoverBorderColor, n, a.getHoverColor(o.borderColor))),
                      (o.borderWidth = i.hoverBorderWidth
                        ? i.hoverBorderWidth
                        : a.valueAtIndexOrDefault(e.pointHoverBorderWidth, n, o.borderWidth));
                  },
                });
              });
          },
                ...
                r.extend(t.prototype, {
                    ...
                    return (
                      r.each(
                        ...
                        function (o, a) {
                          ...
                          if (
                            (r.type && r.type !== s && (e.destroyDatasetMeta(a), (r = e.getDatasetMeta(a))),
                            (r.type = s),
                            i.push(r.type),
                            r.controller)
                          )
                            r.controller.updateIndex(a), r.controller.linkScales();
                          else {
                  ...
                  updateLayout: function () {
                    !1 !== u.notify(this, 'beforeLayout') &&
                      (l.update(this, this.width, this.height), u.notify(this, 'afterScaleUpdate'), u.notify(this, 'afterLayout'));
                  },
                  ...
                  destroy: function () {
                    ...
                    o && (n.unbindEvents(), r.canvas.clear(n), c.releaseContext(n.ctx), (n.canvas = null), (n.ctx = null)),
                      u.notify(n, 'destroy'),
          ...
          function (t, e, i) {
            ...
            e.exports = function () {
              function t(t, e, i) {
                var n;
                return (
                  'string' == typeof t ? ((n = parseInt(t, 10)), -1 !== t.indexOf('%') && (n = (n / 100) * e.parentNode[i])) : (n = t), n
                );
              }
              function e(t) {
                      ...
                      if ('xAxes' === t || 'yAxes' === t) {
                        ...
                        for (e[t] || (e[t] = []), o = 0; o < c; ++o)
                          (l = i[t][o]),
                            ...
                            !e[t][o].type || (l.type && l.type !== e[t][o].type)
                        ...
                        (a.almostEquals(n.deltaK, 0, this.EPSILON)
                          ...
                          : ((r = n.mK / n.deltaK),
                            ...
                            (c = Math.pow(r, 2) + Math.pow(s, 2)) <= 9 ||
                              ((l = 3 / Math.sqrt(c)), (n.mK = r * l * n.deltaK), (o.mK = s * l * n.deltaK))));
                  for (e = 0; e < h; ++e)
                    (n = d[e]).model.skip ||
                      ((i = e > 0 ? d[e - 1] : null),
                      (o = e < h - 1 ? d[e + 1] : null),
                ...
                (a.retinaScale = function (t, e) {
                  ...
                  if (1 !== i) {
                    ...
                    (n.height = o * i),
                      (n.width = a * i),
                      t.ctx.scale(i, i),
                      n.style.height || n.style.width || ((n.style.height = o + 'px'), (n.style.width = a + 'px'));
                  }
                }),
              ...
              update: function (t, e, i) {
                if (t) {
                  ...
                  n.each(h.concat(p, f, m), function (t) {
                    var e,
                      i = t.isHorizontal();
                    i ? ((e = t.update(t.fullWidth ? g : k, w)), (C -= e.height)) : ((e = t.update(x, C)), (k -= e.width)),
                  ...
                  n.each(h.concat(f), N),
                    ...
                    n.each(p, N),
                    n.each(m, N),
                    (t.chartArea = { left: P, top: D, right: P + k, bottom: D + C }),
                    n.each(v, function (e) {
                ...
                function N(t) {
                  t.isHorizontal()
                    ? ((t.left = t.fullWidth ? l : P),
                      ...
                      (t.bottom = W + t.height),
                      (W = t.bottom))
                    : ((t.left = R), (t.right = R + t.width), (t.top = D), (t.bottom = D + C), (R = t.right));
                }
              },
            };
          },
                ...
                notify: function (t, e, i) {
                  ...
                  for (n = 0; n < c; ++n)
                    if (
                      ...
                      ((r = [t].concat(i || [])).push(o.options), !1 === s.apply(a, r))
                    )
                      return !1;
                  return !0;
                },
                ...
                fit: function () {
                  ...
                  if (o.display && h) {
                    ...
                    if (p) {
                      ...
                      0 !== t.labelRotation
                        ? ((t.paddingLeft = 'bottom' === n.position ? k * S + 3 : k * y + 3),
                          (t.paddingRight = 'bottom' === n.position ? k * y + 3 : k * M + 3))
                ...
                _autoSkip: function (t) {
                  ...
                  for (
                    l.maxTicksLimit && (o = l.maxTicksLimit),
                      s &&
                        ((e = !1),
                        (h + l.autoSkipPadding) * c > r.width - (r.paddingLeft + r.paddingRight) &&
                          (e = 1 + Math.floor(((h + l.autoSkipPadding) * c) / (r.width - (r.paddingLeft + r.paddingRight)))),
                ...
                draw: function (t) {
                  ...
                  if (i.display) {
                    ...
                    if (
                      (a.each(v, function (n, o) {
                        if (!a.isNullOrUndef(n.label)) {
                          ...
                          if (m) {
                            ...
                            var z,
                              H = 'left' === i.position;
                            s.mirror ? ((F = H ? 'left' : 'right'), (z = W)) : ((F = H ? 'right' : 'left'), (z = w + W)),
                      ...
                      a.each(T, function (t) {
                        if (
                          ...
                          var i = t.label;
                          if (a.isArray(i))
                            for (var n = i.length, r = 1.5 * b.size, l = e.isHorizontal() ? 0 : (-r * (n - 1)) / 2, c = 0; c < n; ++c)
                      ...
                      var _,
                        ...
                        $ = d(p) / 2;
                      if (m)
                        (_ = e.left + (e.right - e.left) / 2), (E = 'bottom' === i.position ? e.bottom - $ - S.bottom : e.top + $ + S.top);
                      else {
                    ...
                    if (h.drawBorder) {
                      ...
                      m
                        ? ((V = N = 'top' === i.position ? e.bottom : e.top), (V += z), (N += z))
                        : ((R = W = 'left' === i.position ? e.right : e.left), (R += z), (W += z)),
                        o.beginPath(),
                        o.moveTo(R, V),
                        o.lineTo(W, N),
                        o.stroke();
                  ...
                  h.filter &&
                    ...
                    (b = (function (t, e, i, n) {
                      ...
                      return (
                        'right' === c
                          ? (o -= e.width)
                          : 'center' === c && ((o -= e.width / 2) + e.width > n.width && (o = n.width - e.width), o < 0 && (o = 0)),
                      ...
                      (g = (function (t, e) {
                        ...
                        'center' === d
                          ...
                          i(s.x)
                            ? ((u = 'left'), o(s.x) && ((u = 'center'), (d = r(s.y))))
                            : n(s.x) && ((u = 'right'), a(s.x) && ((u = 'center'), (d = r(s.y))));
                        var f = t._options;
            ...
            n._set('global', { elements: { arc: { backgroundColor: n.global.defaultColor, borderColor: '#fff', borderWidth: 2 } } }),
              (e.exports = o.extend({
                ...
                inRange: function (t, e) {
                  ...
                  if (i) {
                    for (
                      var n = a.getAngleFromPoint(i, { x: t, y: e }), o = n.angle, r = n.distance, s = i.startAngle, l = i.endAngle;
                      l < s;
                ...
                getArea: function () {
                  var t = this._view;
                  return (
                    Math.PI * ((t.endAngle - t.startAngle) / (2 * Math.PI)) * (Math.pow(t.outerRadius, 2) - Math.pow(t.innerRadius, 2))
                  );
                },
                tooltipPosition: function () {
                  var t = this._view,
                  ...
                  for (
                    ...
                    (e = c[t]),
                      ...
                      0 === t
                        ...
                        : ((i = -1 === d ? i : c[d]),
                          n.skip || ((d !== t - 1 && !l) || -1 === d ? s.moveTo(n.x, n.y) : a.canvas.lineTo(s, i._view, e._view), (d = t)));
                  s.stroke(), s.restore();
                },
              }));
          },
          ...
          function (t, e, i) {
            ...
            i = e.exports = {
              ...
              lineTo: function (t, e, i, n) {
                if (i.steppedLine)
                  return (
                    ('after' === i.steppedLine && !n) || ('after' !== i.steppedLine && n) ? t.lineTo(e.x, i.y) : t.lineTo(i.x, e.y),
              ...
              o = {
                ...
                merge: function (t, e, i) {
                  ...
                  for (n = (i = i || {}).merger || o._merger, a = 0; a < u; ++a)
                    if (((e = c[a]), o.isObject(e))) for (l = 0, s = (r = Object.keys(e)).length; l < s; ++l) n(r[l], t, e, i);
                  return t;
                },
          ...
          function (t, e, i) {
            ...
            e.exports = {
              ...
              toPadding: function (t) {
                ...
                return (
                  n.isObject(t)
                    ? ((e = +t.top || 0), (i = +t.right || 0), (o = +t.bottom || 0), (a = +t.left || 0))
                    : (e = i = o = a = +t || 0),
                  { top: e, right: i, bottom: o, left: a, height: e + o, width: a + i }
                );
              },
              resolve: function (t, e, i) {
                ...
                for (o = 0, a = t.length; o < a; ++o)
                  if (
                    void 0 !== (r = t[o]) &&
                    (void 0 !== e && 'function' == typeof r && (r = r(e)), void 0 !== i && n.isArray(r) && (r = r[i]), void 0 !== r)
                  )
                    return r;
              },
            };
              ...
              acquireContext: function (t, e) {
                ...
                return i && i.canvas === t
                  ? ((function (t, e) {
                      ...
                      if (
                        ((t[o] = { initial: { height: n, width: a, style: { display: i.display, height: i.height, width: i.width } } }),
          ...
          function (t, e, i) {
            ...
            function s(t, e, i) {
              ...
              if (((n = parseFloat(a, 10)), isFinite(n) && Math.floor(n) === n))
                return ('-' !== a[0] && '+' !== a[0]) || (n = e + n), !(n === e || n < 0 || n >= i) && n;
              switch (a) {
                case 'bottom':
                  return 'start';
                case 'top':
                ...
                for (n = 0; n < d; ++n)
                  (r = null),
                    (a = (i = t.getDatasetMeta(n)).dataset) &&
                      a._model &&
                      a instanceof o.Line &&
                      (r = { visible: t.isDatasetVisible(n), fill: s(a, n, d), chart: t, el: a }),
                    (i.$filler = r),
                    p.push(r);
                      ...
                      for (t.beginPath(), r = 0, s = m + !!a; r < s; ++r)
                        (u = i((c = e[(l = r % m)]._view), l, n)),
                          ...
                          p && f
                            ...
                            : y && x && (v ? (p && g.push(c), f && b.push(u)) : (h(t, g, b, y, x), (y = x = 0), (g = []), (b = [])));
                  ...
                  if (((r.font = p), v)) {
                    ...
                    (r.textAlign = 'left'),
                      ...
                      a.each(t.legendItems, function (e, n) {
                        ...
                        g[g.length - 1] + o + i.padding >= t.width && ((b += u + i.padding), (g[g.length] = t.left)),
                    ...
                    a.each(t.legendItems, function (t, e) {
                      ...
                      C + S > m.height && ((w += k + i.padding), x.push(k), (k = 0), (C = 0)),
                        (k = Math.max(k, n)),
                        (C += S),
              ...
              draw: function () {
                ...
                if (e.display) {
                  ...
                  var b = l(i, f),
                    ...
                    x = t.isHorizontal();
                  u = x
                    ? { x: t.left + (s - c[0]) / 2, y: t.top + i.padding, line: 0 }
                  ...
                  a.each(t.legendItems, function (n, l) {
                    var p = d.measureText(n.text).width,
                      ...
                      g = u.y;
                    x
                      ? v + m >= s && ((g = u.y += w), u.line++, (v = u.x = t.left + (s - c[u.line]) / 2))
                      : g + w > t.bottom && ((v = u.x = v + t.columnWidths[u.line] + i.padding), (g = u.y = t.top + i.padding), u.line++),
                      (function (t, i, n) {
                        if (!(isNaN(b) || b <= 0)) {
                          d.save(),
                      ...
                      (function (t, e, i, n) {
                        ...
                        d.fillText(i.text, a, r),
                          i.hidden && (d.beginPath(), (d.lineWidth = 2), d.moveTo(a, r), d.lineTo(a + n, r), d.stroke());
                      })(v, g, n, p),
            ...
            e.exports = {
              ...
              beforeUpdate: function (t) {
                var e = t.options.legend,
                  i = t.legend;
                e
                  ? (a.mergeIf(e, n.global.legend), i ? (r.configure(t, i, e), (i.options = e)) : u(t, e))
          ...
          function (t, e, i) {
            ...
            var l = o.extend({
              ...
              fit: function () {
                ...
                t.isHorizontal() ? ((s.width = t.maxWidth), (s.height = u)) : ((s.width = u), (s.height = t.maxHeight)),
                  (t.width = s.width),
                  (t.height = s.height);
              },
              afterFit: s,
            ...
            e.exports = {
              ...
              beforeUpdate: function (t) {
                var e = t.options.title,
                  i = t.titleBlock;
                e
                  ? (a.mergeIf(e, n.global.title), i ? (r.configure(t, i, e), (i.options = e)) : c(t, e))
                      ...
                      o.each(n, function (n, a) {
                        ...
                        i.isDatasetVisible(a) &&
                          ...
                          o.each(n.data, function (i, n) {
                            ...
                            isNaN(o) ||
                              s.data[n].hidden ||
                              ((u[n] = u[n] || 0), (d[n] = d[n] || 0), e.relativePoints ? (u[n] = 100) : o < 0 ? (d[n] += o) : (u[n] += o));
                          });
                      }),
                        o.each(l, function (e) {
                    ...
                    a = (t.ticks = (function (t, e) {
                      ...
                      if (t.stepSize && t.stepSize > 0) a = t.stepSize;
                        ...
                        (a = n.niceNum(s / (t.maxTicks - 1), !0)),
                          void 0 !== (o = t.precision) && ((i = Math.pow(10, o)), (a = Math.ceil(a * i) / i));
                      }
                      ...
                      n.isNullOrUndef(t.min) ||
                        ...
                        !t.stepSize ||
                        (n.almostWhole((t.max - t.min) / t.stepSize, a / 1e3) && ((l = t.min), (c = t.max)));
                      var u = (c - l) / a;
                  ...
                  getPixelForValue: function (e) {
                    ...
                    return (
                      ...
                      l.isHorizontal()
                        ...
                        : ((i = l.height), (s *= -1), (o = c ? l.top : l.bottom)),
                      e !== a &&
                        (0 === a && ((i -= h = n.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize)), (a = d)),
            ...
            e.exports = function (t) {
              ...
              var f = t.LinearScaleBase.extend({
                    ...
                    ? (function (t) {
                        ...
                        for (e = 0; e < m; e++) {
                          (n = t.getPointPosition(e, r)),
                            ...
                            (f = t.pointLabels[e] || ''),
                            (i = o.isArray(f)
                              ? { w: o.longestText(h, h.font, f), h: f.length * p + 1.5 * (f.length - 1) * p }
                ...
                getIndexAngle: function (t) {
                  return (
                    t * ((2 * Math.PI) / s(this)) +
                    ((this.chart.options && this.chart.options.startAngle ? this.chart.options.startAngle : 0) * Math.PI * 2) / 360
                  );
                },
                        ...
                        if (
                          (n.display &&
                            ...
                            (function (t, e, i, n) {
                              var a = t.ctx;
                              if (
                                ((a.strokeStyle = o.valueAtIndexOrDefault(e.color, n - 1)),
          ...
          function (t, e, i) {
            ...
            function m(t, e) {
              ...
              return 'function' == typeof i
                ...
                ? n(t, o)
                : (t instanceof n || (t = n(t)), t.isValid() ? t : 'function' == typeof o ? o(t) : t);
            }
            function v(t, e) {
            ...
            function b(t, e, i, o) {
                ...
                l =
                  ...
                  (function (t, e, i, n) {
                    ...
                    for (o = d.indexOf(t); o < s - 1; ++o)
                      if (((r = (a = u[d[o]]).steps ? a.steps[a.steps.length - 1] : c), a.common && Math.ceil((i - e) / (r * a.size)) <= n))
                        return d[o];
                    return d[s - 1];
                  })(s.minUnit, t, e, i),
                h = g(l),
              ...
              for (
                p ||
                  ...
                  r = n(b),
                  m && h && !f && !s.round && (r.startOf(h), r.add(~~((b - r) / (v.size * p)) * p, l));
                r < y;
                r.add(p, l)
              )
                x.push(+r);
            ...
            e.exports = function () {
              var t = r.extend({
                ...
                update: function () {
                  var t = this.options;
                  return (
                    t.time && t.time.format && console.warn('options.time.format is deprecated and replaced by options.time.parser.'),
                ...
                determineDataLimits: function () {
                  ...
                  w.length && ((w = p(w).sort(h)), (g = Math.min(g, w[0])), (b = Math.max(b, w[w.length - 1]))),
                    y.length && ((y = p(y).sort(h)), (g = Math.min(g, y[0])), (b = Math.max(b, y[y.length - 1]))),
                    (g = v(f.min, u) || g),
                    (b = v(f.max, u) || b),
                    (g = g === c ? +n().startOf(m) : g),
                    (b = b === l ? +n().endOf(m) + 1 : b),
                ...
                buildTicks: function () {
                  ...
                  for (
                    'ticks' === s.bounds && c.length && ((a = c[0]), (r = c[c.length - 1])),
                      a = v(l.min, o) || a,
                      r = v(l.max, o) || r,
                      t = 0,
                      e = c.length;
                    ...
                    (o._table = (function (t, e, i, n) {
                      ...
                      for (u.push(i), o = 0, a = u.length; o < a; ++o)
                        (l = u[o + 1]),
                          (r = u[o - 1]),
                          (s = u[o]),
                          (void 0 !== r && void 0 !== l && Math.round((l + r) / 2) === s) || c.push({ time: s, pos: o / (a - 1) });
                      return c;
                    ...
                    (o._offsets = (function (t, e, i, n, o) {
                      ...
                      return (
                        o.offset &&
                          e.length &&
                          (o.time.min ||
                            ((a = e.length > 1 ? e[1] : n), (r = e[0]), (s = (f(t, 'time', a, 'pos') - f(t, 'time', r, 'pos')) / 2)),
                          o.time.max ||
                            ((a = e[e.length - 1]),
                ...
                getPixelForValue: function (t, e, i) {
                  var n = null;
                  if ((void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = v(t, this)), null !== n))
            ...
            t('.wow').each(function () {
              if (
                ...
                ((i + n - 100 > o(this) && n < o(this)) ||
                  (i + n - 100 > o(this) + t(this).height() && n < o(this) + t(this).height()) ||
                  (i + n == t(document).height() && o(this) + 100 > t(document).height()))
              ) {
  ...
  (function (t, e) {
    ...
    function a(t) {
      ...
      return '[object String]' === a
        ? e(t)
        : o(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(a) && t.hasOwnProperty('length')
        ? t
        : o((n = t)) && n.nodeType > 0
        ? [t]
        : [];
    ...
    var l = {
        ...
        show: function (t, e, i) {
          ...
          'touches' in t && t.touches.length
            ? ((a = t.touches[0].pageY - o.top), (c = t.touches[0].pageX - o.left))
        ...
        function u(i) {
          ...
          if (
            ...
            return (
              ...
              a.closeButton && (v.addClass('md-toast-close-button').attr('role', 'button'), u.prepend(v)),
          ...
          function w() {
            clearTimeout(l), (g.hideEta = 0), u.stop(!0, !0)[a.showMethod]({ duration: a.showDuration, easing: a.showEasing });
          }
          function k() {
...
$('.smooth-scroll').on('click', 'a', function () {
  ...
  if (void 0 !== t && 0 === t.indexOf('#')) {
    ...
    return (
      $('body,html').animate({ scrollTop: $(t).offset().top - e }, SMOOTH_SCROLL_DURATION),
  ...
  (function (t) {
    (t.fn.scrollTo = function (e) {
      ...
      (t.fn.dropdown = function (e) {
        ...
        function n(e, n) {
          ...
          var h = 0,
            p = e.parent();
          if (
            (!p.is('body') && p[0].scrollHeight > p[0].clientHeight && (h = p[0].scrollTop),
            r + n.innerWidth() > t(window).width() ? (l = 'right') : r - n.innerWidth() + e.innerWidth() < 0 && (l = 'left'),
            s + n.innerHeight() > o)
          )
          ...
          if ('left' === l) (c = i.gutter), (u = e.position().left + c);
            ...
            u = e.position().left + e.outerWidth() - n.outerWidth() + (c = -i.gutter);
          }
        ...
        return (
          this.each(function () {
            ...
            function r() {
              void 0 !== e.data('induration') && (i.inDuration = e.data('inDuration')),
                void 0 !== e.data('outduration') && (i.outDuration = e.data('outDuration')),
                void 0 !== e.data('constrainwidth') && (i.constrain_width = e.data('constrainwidth')),
                void 0 !== e.data('hover') && (i.hover = e.data('hover')),
                void 0 !== e.data('gutter') && (i.gutter = e.data('gutter')),
                void 0 !== e.data('beloworigin') && (i.belowOrigin = e.data('beloworigin')),
                void 0 !== e.data('alignment') && (i.alignment = e.data('alignment')),
                void 0 !== e.data('maxheight') && (i.maxHeight = e.data('maxheight')),
                void 0 !== e.data('resetscroll') && (i.resetScroll = 'true' === e.data('resetscroll'));
            }
            function s(s) {
              'focus' === s && (o = !0),
                r(),
                a.addClass('active'),
                e.addClass('active'),
                !0 === i.constrain_width ? a.css('width', e.outerWidth()) : a.css('white-space', 'nowrap'),
                n(e, a),
                a
                  .stop(!0, !0)
                  .css('opacity', 0)
            ...
            if ((r(), e.after(a), i.hover)) {
              ...
              e.unbind('click.'.concat(e.attr('id'))),
                e.bind('click.'.concat(e.attr('id')), function (i) {
                  o ||
                    (e[0] !== i.currentTarget || e.hasClass('active') || 0 !== t(i.target).closest('.dropdown-content').length
                      ? e.hasClass('active') &&
                        (l(), t(document).unbind('click.'.concat(a.attr('id'), ' touchstart.').concat(a.attr('id'))))
                      : (i.preventDefault(), s('click')),
                    a.hasClass('active') &&
                      t(document).bind('click.'.concat(a.attr('id'), ' touchstart.').concat(a.attr('id')), function (i) {
                        a.is(i.target) ||
                          e.is(i.target) ||
      ...
      (t.fn.mdbDropSearch = function (e) {
        ...
        var n = t.extend(
          { color: '#000', backgroundColor: '', fontSize: '.9rem', fontWeight: '400', borderRadius: '', borderColor: '' },
          e
        );
        return this.css({
          color: n.color,
...
function dropdownEffectData(t) {
  var e = 'fadeIn',
    ...
    a = n.parents('ul.nav');
  return (
    a.height > 0 && ((e = a.data('dropdown-in') || null), (i = a.data('dropdown-out') || null)),
    { target: t, dropdown: n, dropdownMenu: o, effectIn: o.data('dropdown-in') || e, effectOut: o.data('dropdown-out') || i }
  );
}
  ...
  (function (t) {
    ...
    t('.fixed-action-btn:not(.smooth-scroll) > .btn-floating').on('click', function (o) {
      if (!t(e).hasClass('smooth-scroll'))
        return o.preventDefault(), (a = t('.fixed-action-btn')), (r = a).hasClass('active') ? n(r) : i(r), !1;
      var a, r;
    });
  })(jQuery),
  (function (t) {
          ...
          _createClass(d, [
              ...
              value: function (t) {
                if ('touchmove' === t.type) {
                  ...
                  Date.now() - this.lastTouchVelocity.x.startTime > 20 &&
                    ((this.lastTouchVelocity.x.startPosition = e.clientX), (this.lastTouchVelocity.x.startTime = Date.now())),
            ...
            },
            {
              ...
              value: function (t) {
                var e;
                (e =
                  'left' === this.options.edge ? t / this.options.MENU_WIDTH : Math.abs((t - window.innerWidth) / this.options.MENU_WIDTH)),
            ...
            },
            {
              ...
              value: function () {
                return (
                  Math.abs(this.lastTouchVelocity.x.endPosition - this.lastTouchVelocity.x.startPosition) /
            ...
            },
            {
              ...
              value: function (t, e) {
                this.$menu.velocity(
                  { translateX: t },
                  { duration: 'string' == typeof e ? Number(e) : e, queue: !1, easing: this.options.easingOpen }
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                this.$sidenavOverlay.velocity(
                  { opacity: 1 },
                  { duration: this.options.timeDurationOverlayOpen, queue: !1, easing: this.options.easingOpen }
                );
              },
            },
            {
                  ...
                  if ((i.preventDefault(), !0 === e.menuOut)) e.removeMenu();
                    ...
                    (n = 'left' === e.options.edge ? [0, -1 * e.options.MENU_WIDTH] : [0, e.options.MENU_WIDTH]),
                      'matrix(1, 0, 0, 1, 0, 0)' !== e.$menu.css('transform') &&
                        e.$menu.velocity(
                          { translateX: n },
                          { duration: e.options.timeDurationOpen, queue: !1, easing: e.options.easingOpen }
                        ),
                      e.$sidenavOverlay.on('click', function () {
                        return e.removeMenu();
                      }),
                      e.$sidenavOverlay.on('touchmove', e.touchmoveEventHandler.bind(e)),
            ...
            },
            {
              ...
              value: function () {
                !0 === this.options.showCloseButton &&
                  ...
                  this.$menu.find('.logo-wrapper').css({ borderTop: '1px solid rgba(153,153,153,.3)' }));
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                this.options.MENU_WIDTH !== e &&
                  (this.$menu.css('width', this.options.MENU_WIDTH), i.css('width', this.options.MENU_WIDTH));
              },
            },
            {
              key: 'inputOnClick',
    ...
    t('#toggle').click(function () {
      t('#slide-out').hasClass('slim')
        ? (t('#slide-out').removeClass('slim'),
          t('.sv-slim-icon').removeClass('fa-angle-double-right').addClass('fa-angle-double-left'),
          t('.fixed-sn .double-nav').css({ transition: 'all .3s ease-in-out', 'padding-left': '15.9rem' }),
          t('.fixed-sn main').css({ transition: 'all .3s ease-in-out', 'padding-left': '15rem' }),
          t('.fixed-sn footer').css({ transition: 'all .3s ease-in-out', 'padding-left': '15rem' }))
        : (t('#slide-out').addClass('slim'),
          t('.sv-slim-icon').removeClass('fa-angle-double-left').addClass('fa-angle-double-right'),
          ...
          c = function () {
            e.scaleColor &&
              (function () {
                ...
                for (var n = 24; n > 0; --n)
                  n % 6 == 0 ? ((i = e.scaleLength), (t = 0)) : ((i = 0.6 * e.scaleLength), (t = e.scaleLength - i)),
        ...
        var o = {},
          ...
          r = function () {
            for (var e in ((this.el = t), (this.options = o), n))
              n.hasOwnProperty(e) && ((o[e] = i && void 0 !== i[e] ? i[e] : n[e]), 'function' == typeof o[e] && (o[e] = o[e].bind(this)));
            'string' == typeof o.easing && 'undefined' != typeof jQuery && jQuery.isFunction(jQuery.easing[o.easing])
              ...
              t.dataset && t.dataset.percent
                ...
                : t.getAttribute && t.getAttribute('data-percent') && this.update(parseFloat(t.getAttribute('data-percent')));
          }.bind(this);
  ...
  return (
    _createClass(t, [
        ...
        value: function () {
          this.setWrapperClasses(),
            ...
            this.isDisabled ||
              ...
              (this.view.dropdown = this.view.$materialSelect.dropdown({ hover: !1, closeOnClick: !1, resetScroll: !1 }))),
            this.shouldInheritTabindex && this.view.$materialSelect.attr('tabindex', this.view.$nativeSelect.attr('tabindex')),
        ...
        value: function () {
          if (this.view.options.placeholder)
            this.view.$materialSelect.attr('placeholder', this.view.options.placeholder),
              this.view.$nativeSelect.find('option[value=""][selected][disabled][data-mdb-placeholder]').length ||
      ...
      },
      {
        ...
        value: function () {
          (this.view.$materialSelect.val() || this.view.options.placeholder) && this.view.$mainLabel.addClass('active'),
        ...
        value: function () {
          ...
          (this.view.$searchInput = $(
            '<span class="search-wrap ml-2"><div class="'
              .concat(e, ' mt-0"><input type="text" class="search w-100 d-block ')
      ...
      },
      {
        ...
        value: function (t, e) {
          var i = t.is(':disabled') ? 'disabled' : '',
            ...
            a = t.data('icon'),
            r = t.data('fas')
              ? '<i class="fa-pull-right m-2 fas fa-'.concat(t.data('fas'), ' ').concat(this.view.options.fasClasses, '"></i> ')
              : '',
            s = t.data('far')
              ? '<i class="fa-pull-right m-2 far fa-'.concat(t.data('far'), ' ').concat(this.view.options.farClasses, '"></i> ')
              : '',
            l = t.data('fab')
              ? '<i class="fa-pull-right m-2 fab fa-'.concat(t.data('fab'), ' ').concat(this.view.options.fabClasses, '"></i> ')
              : '',
            c = t.attr('class'),
...
var MaterialSelectView = (function () {
  function t(e, i) {
    ...
    _classCallCheck(this, t),
      ...
      (this.$materialSelectInitialOption = e.find('option:selected').text() || e.find('option:first').text() || ''),
      ...
      [
        ...
        },
        {
          ...
          value: function () {
            ...
            this.$materialSelect.on('focus', function (e) {
              var i = $(e.target);
              if (
                ($('ul.select-dropdown').not(t.$materialOptionsList.get(0)).is(':visible') && $('input.select-dropdown').trigger('close'),
          ...
          value: function (t) {
            ...
            this.$toggleAll.on('click', function (i) {
              var n = $(e.$toggleAll).find('input[type="checkbox"]').first(),
                ...
                a = !o;
              $(n).prop('checked', !o),
                e.$materialOptionsList.find('li:not(.optgroup):not(.select-toggle-all)').each(function (i, n) {
                  var o = $(n),
                  ...
                  o.attr('aria-selected', a),
                    (a && r.is(':checked')) ||
                      ...
                      $(n).is('.disabled') ||
                      (r.prop('checked', a),
                      e.$nativeSelect.find('option').eq(i).prop('selected', a),
                  ...
                  if (!a.hasClass('disabled') && !a.hasClass('optgroup')) {
                    ...
                    if (e.isMultiple) {
                      ...
                      e.$materialOptionsList.find('li').removeClass('active').attr('aria-selected', 'false'),
                        e.$materialSelect.val(a.text().replace(/  +/g, ' ').trim()),
                    ...
                    a.attr('aria-selected', 'true' === c ? 'false' : 'true'),
                      ...
                      e.$nativeSelect.removeData('stop-refresh'),
                      e._triggerChangeOnNativeSelect(),
                      e.$materialSelect.val() && e.$mainLabel.addClass('active'),
                      a.hasClass('li-added') && e.renderer.buildSingleOption(a, '');
                  }
                });
              });
          },
              ...
              if (
                (u.each(function () {
                  ...
                  if ('string' == typeof this.outerHTML) {
                    ...
                    e.includes(c.toLowerCase()) ? t.show().parent().show() : t.hide().parent().hide(),
                ...
                return t.isEditable && !d
                  ...
                  : (r && t._handleEnterWithShiftKey(i), void t.$materialSelect.trigger('open'));
              t.$addOptionBtn[c && t.isEditable && !d ? 'show' : 'hide'](),
                0 !==
                u.filter(function (t, e) {
                  return $(e).is(':visible') && !$(e).parent().hasClass('disabled');
                }).length
                  ? (t.$toggleAll.show(), t.$materialOptionsList.find(t.$noSearchResultsInfo).remove(), t._updateToggleAllOption())
                  : (t.$toggleAll.hide(), t.$materialOptionsList.append(t.$noSearchResultsInfo)),
                t.dropdown.updatePosition(t.$materialSelect, t.$materialOptionsList);
            });
          },
        },
        {
          ...
          value: function () {
            ...
            $('html').on('click', function (e) {
              $(e.target).closest('#select-options-'.concat(t.properties.id)).length ||
                $(e.target).hasClass('mdb-select') ||
                !$('#select-options-'.concat(t.properties.id)).hasClass('active') ||
                (t.$materialSelect.trigger('close'),
                t.$materialSelect.val() || t.options.placeholder || t.$mainLabel.removeClass('active')),
                t.isSearchable &&
                  null !== t.$searchInput &&
                  t.$materialOptionsList.hasClass('active') &&
                  t.$materialOptionsList.find('.search-wrap input.search').focus();
            });
          },
        },
        {
        ...
        },
        {
          ...
          value: function () {
            ...
            e.length !== t.length || i
              ? e.length < t.length && i && this.$toggleAll.find('[type=checkbox]').prop('checked', !1)
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (t === this.keyCodes.arrowUp) {
              ...
              (s = c),
                i.each(function (t, n) {
                  $(n).hasClass(e.options.keyboardActiveClass) && ((c = i.eq(t - 1)), (s = i.eq(t)));
                }),
                (r = l.is(n) || !a ? l : c);
            } else {
              ...
              (s = d),
                i.each(function (t, n) {
                  $(n).hasClass(e.options.keyboardActiveClass) && ((d = i.eq(t + 1)), (s = i.eq(t)));
                }),
                (r = u.is(o) || !a ? u : d);
            }
      ...
      function e(t) {
        ...
        _classCallCheck(this, e),
          (this.options = {
            ...
            selectId: this.fallback().or(t.attr('data-native-id')).or(i.selectId).or(null).value(),
          ...
          (this.uuid = t.attr('id') || this.options.selectId || this._randomUUID()),
          (this.view = new MaterialSelectView(t, { options: this.options, properties: { id: this.uuid } })),
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                ...
                t.observe(this.view.$nativeSelect.get(0), { attributes: !0, childList: !0, characterData: !0, subtree: !0 }),
              ...
              value: function (i) {
                i.forEach(function (i) {
                  ...
                  !0 !== n.data('stop-refresh') &&
                    ('childList' === i.type || ('attributes' === i.type && t(i.target).is('option'))) &&
                    (e.clearMutationObservers(), n.materialSelect({ destroy: !0 }), n.materialSelect());
                });
              },
            },
            {
              ...
              value: function (t) {
                var e = this.selectedOptionsIndexes.indexOf(t),
                  i = -1 !== e;
                return (
                  i ? this.selectedOptionsIndexes.splice(e, 1) : this.selectedOptionsIndexes.push(t),
                  this.view.$nativeSelect.find('option').eq(t).prop('selected', !i),
                  ...
                  0 ===
                    (e =
                      this.options.maxSelectedOptions >= 0 && i > this.options.maxSelectedOptions
                        ...
                        : e.substring(2)).length && (e = this.view.$nativeSelect.find('option:disabled').eq(0).text()),
                  this.view.$nativeSelect
                    .siblings(''.concat(this.options.defaultMaterialInput ? 'input.multi-bs-select' : 'input.select-dropdown'))
                    .val(e);
              },
            },
            {
    ...
    function a(e, n, c, d) {
      ...
      var h = !1,
        ...
        y = (b.prototype = {
          ...
          start: function () {
            return p && p.start
              ...
              : ((p.methods = {}),
                  ...
                  (function () {
                    ...
                    (y._hidden = t(
                      '<input type=hidden name="' +
                        i +
                        '"' +
                        (v.data('value') || e.value ? ' value="' + y.get('select', f.formatSubmit) + '"' : '') +
                        '>'
                    )[0]),
                ...
                f.containerHidden ? t(f.containerHidden).append(y._hidden) : v.after(y._hidden),
          ...
          render: function (e) {
            return (
              e ? ((y.$holder = t(x())), w(), y.$root.html(y.$holder)) : y.$root.find('.' + m.box).html(y.component.nodes(p.open)),
              y.trigger('render')
            );
          },
          stop: function () {
                    ...
                    i
                      ...
                      .on('keydown.' + p.id, function (i) {
                        ...
                        27 == n
                          ? y.close(!0)
                          : r != y.$holder[0] || (!o && 13 != n)
                          ? t.contains(y.$root[0], r) && 13 == n && (i.preventDefault(), r.click())
                          : (i.preventDefault(),
                            o
                              ? a._.trigger(y.component.key.go, y, [a._.trigger(o)])
                              : y.$root.find('.' + m.highlighted).hasClass(m.disabled) ||
                                (y.set('select', y.component.item.highlight), f.closeOnSelect && y.close(!0)));
                      })),
                  y.trigger('open'))
            );
          },
          ...
          set: function (e, i, n) {
            ...
            if (((n = r && t.isPlainObject(i) ? i : n || {}), e)) {
              for (o in (r || (s[e] = i), s))
                (a = s[o]),
                  o in y.component.item && (void 0 === a && (a = null), y.component.set(o, a, n)),
                  ('select' != o && 'clear' != o) || !f.updateInput || v.val('clear' == o ? '' : y.get(o, f.format)).trigger('change');
              y.render();
            }
      ...
      function x() {
        return a._.node(
          'div',
          a._.node('div', a._.node('div', a._.node('div', y.component.nodes(p.open), m.box), m.wrap), m.frame),
          m.holder,
          'tabindex="-1"'
        );
      }
      ...
      (a._ = {
        group: function (t) {
          for (var e, i = '', n = a._.trigger(t.min, t); n <= a._.trigger(t.max, t, [n]); n += t.i)
            (e = a._.trigger(t.item, t, [n])), (i += a._.node(t.node, e[0], e[1], e[2]));
          return i;
        },
    ...
    (o.prototype.set = function (t, e, i) {
      ...
      (o.prototype.validate = function (t, i, o) {
        ...
        if (
          ...
          ((!h && c.disabled(i)) || (h && c.disabled(i) && (m || a || r)) || (!h && (i.pick <= p.pick || i.pick >= f.pick)))
        )
          for (
            h && !m && ((!r && d > 0) || (!a && d < 0)) && (d *= -1);
            c.disabled(i) &&
                ...
                for (l = 0; l < r; l += 1) {
                  ...
                  if (o.isDateOverlap(s, t)) {
                    e.isPlainObject(t)
                      ...
                      : n.isDate(t) && (i = [t.getFullYear(), t.getMonth(), t.getDate(), 'inverted']);
                    break;
                  }
                }
                if (i)
          ...
          m = function (t) {
            return n.node(
              ...
              a.klass['nav' + (t ? 'Next' : 'Prev')] +
                ((t && u.year >= p.year && u.month >= p.month) || (!t && u.year <= h.year && u.month <= h.month)
                  ? ' ' + a.klass.navDisabled
                  : ''),
              'data-nav=' +
                (t || -1) +
                    ...
                    item: function (t) {
                      return [
                        ...
                        'value=' +
                          t +
                          (u.month == t ? ' selected' : '') +
                          ((u.year == h.year && t < h.month) || (u.year == p.year && t > p.month) ? ' disabled' : ''),
                      ];
                    },
                  }),
                  a.klass.selectMonth,
        ...
        return (
          ...
          n.node(
            ...
            n.node(
              ...
              a.today,
              a.klass.buttonToday,
              'type=button data-pick=' + s.pick + (t && !o.disabled(s) ? '' : ' disabled') + ' ' + n.ariaAttr({ controls: o.$node[0].id })
            ) +
              n.node(
                'button',
                a.clear,
                a.klass.buttonClear,
                'type=button data-clear=1' + (t ? '' : ' disabled') + ' ' + n.ariaAttr({ controls: o.$node[0].id })
              ) +
              n.node(
                'button',
                a.close,
                a.klass.buttonClose,
                'type=button data-close=true ' + (t ? '' : ' disabled') + ' ' + n.ariaAttr({ controls: o.$node[0].id })
              ),
            a.klass.footer
          )
        );
    ...
    function M(t, e) {
      ...
      if (e.twelvehour)
        for (E = 0; E < 12; E += e.hourstep)
          (L = R.clone()),
            ...
            (F = y),
            L.css('font-size', '140%'),
            L.css({ left: b + Math.sin($) * F - w, top: b - Math.cos($) * F - w }),
            L.html(0 === E ? 12 : E),
            p.append(L),
            L.on(u, N);
      else
      ...
      for (E = 0; E < 60; E += V)
        for (E = 0; E < 60; E += 5)
          (L = R.clone()),
            ($ = (E / 30) * Math.PI),
            L.css({ left: b + Math.sin($) * y - w, top: b - Math.cos($) * y - w }),
            L.css('font-size', '140%'),
            L.html(v(E)),
            M.append(L),
            L.on(u, N);
    ...
    (M.DEFAULTS = {
      ...
      (M.prototype.setHand = function (t, e, i, o) {
        ...
        if (
          ...
          c
            ? ((r *= d.hourstep), d.twelvehour || !h != r > 0 || (r += 12), d.twelvehour && 0 === r && (r = 12), 24 === r && (r = 0))
      ...
      (M.prototype.done = function () {
        ...
        this.isHTML5 &&
          this.options.twelvehour &&
          (this.hours < 12 && 'PM' === this.amOrPm && (e += 12), 12 === this.hours && 'AM' === this.amOrPm && (e = 0)),
          (i = v(e) + i),
    ...
    return function (t, e, i, n) {
      ...
      var s,
        ...
        It = function (t, e, i, n, o) {
          (!yt || (o && o !== a.currItem)) && (n /= o ? o.fitRatio : a.currItem.fitRatio),
            (t[O] = b + e + 'px, ' + i + 'px' + y + ' scale(' + n + ')');
        },
        Ot = function (t) {
          tt &&
            (t && (v > a.currItem.fitRatio ? yt || (Ke(a.currItem, !1, !0), (yt = !0)) : yt && (Ke(a.currItem), (yt = !1))),
            It(tt, ut.x, ut.y, v));
        },
        Pt = function (t) {
        ...
        Nt = function (t, e, i, n) {
          return n === a.currItem.initialZoomLevel
            ...
            : ((i[t] = _t(t, n)), i[t] > e.min[t] ? ((i[t] = e.min[t]), !0) : i[t] < e.max[t] && ((i[t] = e.max[t]), !0));
        },
        zt = function (t) {
          var e = '';
          r.escKey && 27 === t.keyCode
            ? (e = 'close')
            : r.arrowKeys && (37 === t.keyCode ? (e = 'prev') : 39 === t.keyCode && (e = 'next')),
            e &&
              (t.ctrlKey || t.altKey || t.shiftKey || t.metaKey || (t.preventDefault ? t.preventDefault() : (t.returnValue = !1), a[e]()));
        },
        Ht = function (t) {
        ...
        Qt = {
          ...
          init: function () {
            if (!s && !l) {
              ...
              for (
                (R.animationName && R.transform && !n) || (r.showAnimationDuration = r.hideAnimationDuration = 0), i = 0;
                i < gt.length;
                i++
              )
                a['init' + gt[i]]();
              e && (a.ui = new e(a, o)).init(),
                ...
                r.modal && (vt ? (t.style.position = 'fixed') : ((t.style.position = 'absolute'), (t.style.top = o.getScrollY() + 'px'))),
          ...
          panTo: function (t, e, i) {
            i || (t > J.min.x ? (t = J.min.x) : t < J.max.x && (t = J.max.x), e > J.min.y ? (e = J.min.y) : e < J.max.y && (e = J.max.y)),
              (ut.x = t),
              (ut.y = e),
              Ot();
          },
          ...
          updateCurrItem: function (t) {
            if (0 !== mt) {
              ...
              if (!(t && 2 > i)) {
                ...
                for (var n = 0; i > n; n++)
                  mt > 0
                    ? ((e = k.shift()), (k[2] = e), At((++h + 2) * ft.x, e.el.style), a.setContent(e, u - i + n + 1 + 1))
                    : ((e = k.pop()), k.unshift(e), At(--h * ft.x, e.el.style), a.setContent(e, u + i - n - 1 - 1));
                if (tt && 1 === Math.abs(mt)) {
                  var o = Ve(C);
          ...
          updateSize: function (e) {
            ...
            (g = v = a.currItem.initialZoomLevel),
              (J = a.currItem.bounds) && ((ut.x = J.center.x), (ut.y = J.center.y), Ot(!0)),
              St('resize');
          },
          zoomTo: function (t, e, i, n, a) {
            ...
            var d = function (e) {
              1 === e
                ...
                : ((v = (t - l) * e + l), (ut.x = (s.x - c) * e + c), (ut.y = (s.y - u) * e + u)),
                a && a(e),
                Ot(1 === e);
            };
        ...
        Se = function (t) {
          ...
          return (
            P
              ...
              ? t.touches &&
                t.touches.length > 0 &&
                ((Ce[0] = be(t.touches[0], we)), t.touches.length > 1 && (Ce[1] = be(t.touches[1], ke)))
          ...
          return (
            ...
            (tt
              ? 'h' !== it ||
                ...
                q ||
                (c
                  ? (l > J.min[t] && ((i = r.panEndFriction), J.min[t], (n = J.min[t] - ct[t])),
                    (0 >= n || 0 > d) && Ne() > 1 ? ((s = u), 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))
                  : (l < J.max[t] && ((i = r.panEndFriction), J.max[t], (n = ct[t] - J.max[t])),
                    (0 >= n || d > 0) && Ne() > 1 ? ((s = u), d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)))
              : (s = u),
            'x' !== t)
              ? void (et || K || (v > a.currItem.fitRatio && (ut[t] += e[t] * i)))
              : (void 0 !== s && (Dt(s, !0), (K = s !== ne.x)),
                J.min.x !== J.max.x && (void 0 !== o ? (ut.x = o) : K || (ut.x += e.x * i)),
                void 0 !== s)
          );
        },
        Te = function (t) {
          ...
          if (Q) {
            ...
            if (0 !== t)
              if ((Et(Zt, Q[0]), (Jt.x = Zt.x - te.x), (Jt.y = Zt.y - te.y), Z && t > 1)) {
                ...
                if (!it) return;
                if (
                  (nt && ((nt = !1), Math.abs(Jt.x) >= 10 && (Jt.x -= Q[0].x - ee.x), Math.abs(Jt.y) >= 10 && (Jt.y -= Q[0].y - ee.y)),
                  (te.x = Zt.x),
                  (te.y = Zt.y),
                  0 === Jt.x && 0 === Jt.y)
                )
        ...
        Pe = function (t) {
          ...
          var c = -1;
          if (
            (0 === l && ((j = !1), o.unbind(window, p, a), pe(), Z ? (c = 0) : -1 !== le && (c = Mt() - le)),
            (le = 1 === l ? Mt() : -1),
            (n = -1 !== c && 150 > c ? 'zoom' : 'swipe'),
            Z && 2 > l && ((Z = !1), 1 === l && (n = 'zoomPointerUp'), St('zoomGestureEnded')),
            (Q = null),
            X || q || et || H)
          )
            ...
            i = {
                ...
                i.backAnimStarted[t] ||
                  ...
                  void 0 !== i.backAnimDestination[t] &&
                    ...
                    i.speedDecelerationRatioAbs[t] < 0.05 &&
                      ...
                      Kt('bounceZoomPan' + t, ut[t], i.backAnimDestination[t], e || 300, o.easing.sine.out, function (e) {
                        (ut[t] = e), Ot();
                      }))));
              },
              ...
              panAnimLoop: function () {
                return jt.zoomPan &&
                  ...
                  ? ((ut.x = Math.round(ut.x)), (ut.y = Math.round(ut.y)), Ot(), void qt('zoomPan'))
                  : void 0;
              },
            };
          return i;
        ...
        _e = function (t, e) {
          ...
          n &&
            (0 > (u += n) ? ((u = r.loop ? Ne() - 1 : 0), (s = !0)) : u >= Ne() && ((u = r.loop ? 0 : Ne() - 1), (s = !0)),
        ...
        publicMethods: {
          initGestures: function () {
            ...
            (P = R.pointerEvent) && R.touch && (R.touch = !1),
              ...
              (p = M + ' ' + T + ' ' + I),
              (f = S),
              P && !A && (A = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1),
      ...
      var $e,
        ...
        ze = function (e, i, n, s) {
          ...
          !(function () {
            ...
            e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = 'hidden'),
              n || ((v = l.w / e.w), (ut.x = l.x), (ut.y = l.y - L), (a[s ? 'template' : 'bg'].style.opacity = 0.001), Ot()),
              Xt('initialZoom'),
                    ...
                    var a = l.w / e.w,
                      ...
                      p = function (e) {
                        1 === e
                          ...
                          : ((v = (a - c) * e + c), (ut.x = (l.x - r.x) * e + r.x), (ut.y = (l.y - F - r.y) * e + r.y)),
                          Ot(),
        ...
        Ye = function (t, e, i) {
          if (t.src && !t.loadError) {
            var n = !i;
            if (
              (n && (t.vGap || (t.vGap = { top: 0, bottom: 0 }), St('parseVerticalMargin', t)),
              (He.x = e.x),
        ...
        Ue = function (t, e) {
          return t.src && t.loadError && t.container
            ? (e && (t.container.innerHTML = ''), (t.container.innerHTML = r.errorMsg.replace('%url%', t.src)), !0)
            : void 0;
        },
        Ke = function (t, e, i) {
          if (t.src) {
          ...
          setContent: function (t, e) {
            ...
            if (l) {
              ...
              if (
                ...
                l.src &&
                  !l.loadError &&
                  (((n = o.createEl('pswp__img', 'img')).style.opacity = 1), (n.src = l.src), Ke(l, n), qe(0, l, c, n));
              else {
                if (
                  ((l.loadComplete = function (i) {
                    if (s) {
                      if (t && t.index === e) {
                        if (Ue(i, !0))
                          return (i.loadComplete = i.img = null), Ye(i, dt), Pt(i), void (t.index === u && a.updateCurrZoomItem());
                        i.imageAppended
                          ? !We && i.placeholder && ((i.placeholder.style.display = 'none'), (i.placeholder = null))
                          : R.transform && (et || We)
                          ? Be.push({ item: i, baseDiv: c, img: i.img, index: e, holder: t, clearPlaceholder: !0 })
                          : qe(0, i, c, i.img, 0, !0);
                      }
                ...
                l.loading || Xe(l),
                  a.allowProgressiveImg() &&
                    (!Re && R.transform ? Be.push({ item: l, baseDiv: c, img: l.img, index: e, holder: t }) : qe(0, l, c, l.img, 0, !0));
              }
        ...
        xt('DesktopZoom', {
          publicMethods: {
            ...
            setupDesktopZoom: function (e) {
              ...
              var n,
                r = function () {
                  a.mouseZoomedIn && (o.removeClass(t, 'pswp--zoomed-in'), (a.mouseZoomedIn = !1)),
                    1 > v ? o.addClass(t, 'pswp--zoom-allowed') : o.removeClass(t, 'pswp--zoom-allowed'),
                    s();
                },
                s = function () {
            ...
            handleMouseWheel: function (t) {
              if (v <= a.currItem.fitRatio)
                return (
                  r.modal && (!r.closeOnScroll || Yt || j ? t.preventDefault() : O && Math.abs(t.deltaY) > 2 && ((c = !0), a.close())), !0
                );
              if ((t.stopPropagation(), (Ge.x = 0), 'deltaX' in t))
                1 === t.deltaMode ? ((Ge.x = 18 * t.deltaX), (Ge.y = 18 * t.deltaY)) : ((Ge.x = t.deltaX), (Ge.y = t.deltaY));
              else if ('wheelDelta' in t)
                t.wheelDeltaX && (Ge.x = -0.16 * t.wheelDeltaX),
                  t.wheelDeltaY ? (Ge.y = -0.16 * t.wheelDeltaY) : (Ge.y = -0.16 * t.wheelDelta);
              else {
      ...
      var ei,
        ...
        gi = function () {
          if ((ni && clearTimeout(ni), Yt || j)) ni = setTimeout(gi, 500);
            ...
            hi
              ? '#' + i !== window.location.hash && history[li ? 'replaceState' : 'pushState']('', document.title, n)
              : li
              ? di.replace(n)
              : (di.hash = i),
              (li = !0),
    ...
    return function (t, e) {
      var i,
        ...
        M = function (t) {
          ...
          for (var i, n, o = (t.target || t.srcElement).getAttribute('class') || '', a = 0; a < V.length; a++)
            (i = V[a]).onTap && o.indexOf('pswp__' + i.name) > -1 && (i.onTap(), (n = !0));
          if (n) {
        ...
        E = function (t) {
          for (var i = 0; i < v.closeElClasses.length; i++) if (e.hasClass(t, 'pswp__' + v.closeElClasses[i])) return !0;
        },
        L = 0,
        $ = function () {
        ...
        W = function (t) {
          ...
          if (T()) {
            ...
            if (v.captionEl && 'auto' === r.bottom)
              if (
                (a ||
                  ((a = e.createEl('pswp__caption pswp__caption--fake')).appendChild(e.createEl('pswp__caption__center')),
                  n.insertBefore(a, o),
      ...
      (x.init = function () {
        e.extend(t.options, S, !0),
          ...
          d('destroy', function () {
            v.captionEl && (a && n.removeChild(a), e.removeClass(o, 'pswp__caption--empty')),
          ...
          v.fullscreenEl &&
            ...
            i
              ? (e.bind(document, i.eventK, x.updateFullscreen), x.updateFullscreen(), e.addClass(t.template, 'pswp--supports-fs'))
              ...
              clearTimeout(f),
                (f = setTimeout(function () {
                  t.currItem && t.currItem.loading
                    ? (!t.allowProgressiveImg() || (t.currItem.img && !t.currItem.img.naturalWidth)) && R(!1)
                    : R(!0);
        ...
        (x.update = function () {
          k && t.currItem
            ? (x.updateIndexIndicator(),
              v.captionEl && (v.addCaptionHTMLFn(t.currItem, o), I(o, 'caption--empty', !t.currItem.title)),
              (w = !0))
            : (w = !1),
            C || A(),
            O();
        ...
        (x.onGlobalTap = function (i) {
          ...
          if (!g)
            if (i.detail && 'mouse' === i.detail.pointerType) {
              ...
              (v.tapToToggleControls && (k ? x.hideControls() : x.showControls()), v.tapToClose && (e.hasClass(n, 'pswp__img') || E(n)))
            )
              return void t.close();
        }),
...
initPhotoSwipeFromDOM('.mdb-lightbox'),
  ...
  (function (t, e) {
    ...
    function p(t, i) {
      ...
      i.isScrollbarYUsingRight
        ...
        : i.isRtl
        ? (a.left =
            i.negativeScrollAdjustment + t.scrollLeft + 2 * i.containerWidth - i.contentWidth - i.scrollbarYLeft - i.scrollbarYOuterWidth)
      ...
      C = function (t) {
        ...
        (t.containerWidth = e.clientWidth),
          ...
          t.scrollbarXActive
            ...
            : (e.classList.remove(v.state.active('x')), (t.scrollbarXWidth = 0), (t.scrollbarXLeft = 0), (e.scrollLeft = 0)),
          t.scrollbarYActive
            ? e.classList.add(v.state.active('y'))
            : (e.classList.remove(v.state.active('y')), (t.scrollbarYHeight = 0), (t.scrollbarYTop = 0), (e.scrollTop = 0));
      },
      S = {
            ...
            if (!i(t.target, a, r)) {
              ...
              e.settings.useBothWheelAxes
                ? e.scrollbarYActive && !e.scrollbarXActive
                  ...
                  : e.scrollbarXActive &&
                    !e.scrollbarYActive &&
                    (a ? (o.scrollLeft += a * e.settings.wheelSpeed) : (o.scrollLeft -= r * e.settings.wheelSpeed), (s = !0))
              ...
              : k.supportsIePointer &&
                (window.PointerEvent
                  ...
                  : window.MSPointerEvent &&
                    (e.event.bind(u, 'MSPointerDown', r), e.event.bind(u, 'MSPointerMove', l), e.event.bind(u, 'MSPointerUp', c)));
          }
        },
      },
      M = function (n, o) {
        var a = this;
        if ((void 0 === o && (o = {}), 'string' == typeof n && (n = document.querySelector(n)), !n || !n.nodeName))
    ...
    var e = (function () {
      function e(i, n) {
        _classCallCheck(this, e),
          ...
          (this.ulWrapper = t('<ul class="chip-ul z-depth-1" tabindex="0"></ul>')),
          ...
          (this.keyCodes = { enter: 13, backspace: 8, delete: 46, arrowLeft: 37, arrowRight: 39, comma: 188 }),
          this.init();
      }
      return (
        _createClass(e, [
            ...
            value: function () {
              ...
              this.chips.on('keydown', 'input', function (i) {
                ...
                if ((l || c) && !e.ulWrapper.find('li').hasClass('selected'))
                  return i.preventDefault(), e.addChip(r, { tag: n.val() }, a), void n.val('');
                var h = i.keyCode === e.keyCodes.arrowLeft || i.keyCode === e.keyCodes.delete,
                  p = '' === n.val();
                h && p && s && e.selectChip(r, s - 1, a),
                  p && t(e.selectors.input).hasClass('active') ? u && e.selectChip(r, s - 1, a) : o.find('.chip').removeClass('selected');
            ...
            value: function () {
              ...
              this.chips.on('click', '.chip .fas', function (i) {
                ...
                o.parents().eq(1).hasClass('chips-autocomplete')
                  ? (n = o.parents().eq(1))
                  : o.parent().hasClass('chips-autocomplete') || o.parents().eq(1).hasClass('chips-autocomplete')
                  ? o.parent().hasClass('chips-initial') && o.parent().hasClass('chips-autocomplete') && (n = o.parents().eq(0))
                  : (n = o.parents().eq(0)),
                ...
                if ((i.empty(), s.length))
                  for (var l in n)
                    n[l].toLowerCase().includes(s.toLowerCase()) &&
                      o.children('.chip-position-wrapper').append(i.append(t('<li>'.concat(n[l], '</li>'))));
            ...
            value: function () {
              ...
              this.chips.on('click', 'li', function (i) {
                ...
                e.addChip(a, { tag: n.text() }, o),
                  e.chips.children('.chip-position-wrapper').children('input').val(''),
                  e.ulWrapper.remove();
              });
            },
          },
            ...
            value: function (t) {
              ...
              t.data('chips').forEach(function (t) {
                ...
                t.hasClass('chips-autocomplete')
                  ? (i += '<span class="chip-position-wrapper position-relative"><input class="input" placeholder=""></span>')
          ...
          },
          {
            ...
            value: function (t) {
              ...
              t.data('chips').length && e.placeholder
                ...
                : !t.data('chips').length && e.secondaryPlaceholder && t.find('input').prop('placeholder', e.secondaryPlaceholder);
            },
          },
          {
            key: 'isValid',
          ...
          },
          {
            ...
            value: function (e, i, n) {
              if (this.isValid(n, i)) {
                ...
                n.data('chips').push(i),
                  n.hasClass('chips-autocomplete') && n.hasClass('chips-initial') && n.find('.chip').length > 0
        ...
        var w =
                    ...
                    return (
                      ...
                      t &&
                        (this.options.keepImg
                          ...
                          : ((this.image.$item = t), (this.image.$itemParent = t.parentNode)),
                  ...
                  value: function (t) {
                    ...
                    if (
                      ...
                      if (
                        ...
                        var v = 1;
                        this.options.speed < 0 ? (v -= this.options.speed * m) : (v += this.options.speed * (1 - m)),
          ...
          S = function (t) {
            ('object' === ('undefined' == typeof HTMLElement ? 'undefined' : a(HTMLElement))
              ...
              : t && 'object' === (void 0 === t ? 'undefined' : a(t)) && null !== t && 1 === t.nodeType && 'string' == typeof t.nodeName) &&
              (t = [t]);
            for (var e = arguments[1], i = Array.prototype.slice.call(arguments, 2), n = t.length, o = 0, r = void 0; o < n; o++)
              if (
                ('object' === (void 0 === e ? 'undefined' : a(e)) || void 0 === e
                  ? t[o].jarallax || (t[o].jarallax = new C(t[o], e))
                  : t[o].jarallax && (r = t[o].jarallax[e].apply(t[o].jarallax, i)),
                void 0 !== r)
              )
                return r;
            return t;
              ...
              },
              {
                ...
                value: function (t) {
                  var e,
                    ...
                    n,
                    o,
                    a = !(!(e = t.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== e[1].length) && e[1],
                    r = (function (t) {
                      var e = t.match(
                              ...
                              e.options.loop && t.data === YT.PlayerState.ENDED && e.play(e.options.startTime),
                                ...
                                t.data === YT.PlayerState.PLAYING
                                  ? (o = setInterval(function () {
                                      e.fire('timeupdate', t),
                                        e.options.endTime &&
                                          e.player.getCurrentTime() >= e.options.endTime &&
                                          (e.options.loop ? e.play(e.options.startTime) : e.pause());
                                    }, 150))
                                  : clearInterval(o);
                            },
                          };
              ...
              },
              {
                ...
                value: function () {
                  if (!s || !l) {
                    var t = '';
                    if (
                      ('youtube' !== this.type || s || ((s = 1), (t = 'https://www.youtube.com/iframe_api')),
                      'vimeo' !== this.type || l || ((l = 1), (t = 'https://player.vimeo.com/api/player.js')),
                      t)
                    ) {
      ...
      Object.defineProperty(e, '__esModule', { value: !0 }),
        (e.default = function () {
          ...
          e.prototype.coverImage = function () {
            ...
            if (t && this.video && e && ('IFRAME' === e || 'VIDEO' === e)) {
              var i = t.image.height,
                ...
                r = t.image.marginTop;
              t.container.width > n &&
                ((n = t.container.width), (i = (n * this.image.height) / this.image.width), (o = 0), (r += (t.image.height - i) / 2)),
          ...
          e.prototype.initImg = function () {
            var t = r.apply(this);
            return (
              this.options.videoSrc || (this.options.videoSrc = this.$item.getAttribute('data-jarallax-video') || null),
                ...
                if (
                  ...
                  return 'local' !== i.type
                    ? (i.getImageURL(function (e) {
                      ...
                      !1)
                    : ((t.image.src = 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7'), !0);
              } else
                t.defaultInitImgResult ||
                  i.getImageURL(function (e) {
            ...
            },
            {
              ...
              value: function () {
                ...
                this.$input.on('keyup', function (i) {
                  if (13 === i.which)
                    return (
                      e.options.data.includes(e.$input.val()) || e.options.data.push(e.$input.val()),
                  ...
                  if ((e.$autocompleteWrap.empty(), n.length)) {
                    ...
                    if (40 === i.which) {
                      ...
                      38 === i.which &&
                        (c < 1 ? ((c = s.length), r.scrollTop(r.prop('scrollHeight')), (u = r.prop('scrollHeight') - l)) : c--,
                        (u -= d),
                        r.scrollTop(u),
              ...
              value: function () {
                ...
                this.$input.hasClass('mdb-autocomplete') &&
                  ...
                  this.$input.on('blur', function (i) {
                    i.preventDefault(),
                      t(i.target).parent().find('.mdb-autocomplete-clear').find('svg').css('fill', e.options.closeBlurColor);
                  }));
              },
            },
          ]),
  ...
  (function (t, e) {
    ...
    function s() {
      for (
        var e = [].slice.call(this.querySelectorAll(t.INPUT)).filter(function (t) {
    ...
    return {
      init: function (i, n) {
        ...
        for (
          var o = [].slice.call(document.querySelectorAll(i)), a = [].slice.call(document.querySelectorAll(n)), u = 0, d = o.length;
          u < d;
          u++
        ) {
          var h = o[u];
          Object.defineProperty(h, 'bsCustomFileInput', { value: { defaultText: e(h) }, writable: !0 }),
            r.call(h),
            h.addEventListener(c, r);
        }
        for (var p = 0, f = a.length; p < f; p++)
          a[p].addEventListener(l, s), Object.defineProperty(a[p], 'bsCustomFileInput', { value: !0, writable: !0 });
      },
      destroy: function () {
        for (
          var e = [].slice.call(document.querySelectorAll(t.FORM)).filter(function (t) {
              return !!t.bsCustomFileInput;
            }),
