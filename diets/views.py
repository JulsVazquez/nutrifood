...
def diet(request):
    ...
    response = {'recipes': []}
    for tag in tags:
        url = f'https://api.spoonacular.com/recipes/random?apiKey=308c4ea0ef67478eace9c54c39a12c43&number=1&tag={tag},healthy'
...
def detail(request, id):
    ...
    session.headers.update({'Content-Type': 'application/json',
                           'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.76 Safari/537.36'})
    url = f'https://api.spoonacular.com/recipes/{id}/information?apiKey=308c4ea0ef67478eace9c54c39a12c43'
